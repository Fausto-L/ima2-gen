...
export const config = {
    ...
    dashscopeProvider: {
        defaultImageModel: pickStr(env.IMA2_DASHSCOPE_IMAGE_MODEL_DEFAULT, fileCfg.dashscopeProvider?.defaultImageModel, "wanx2.1-t2i-turbo"),
        generationTimeoutMs: pickInt(env.IMA2_DASHSCOPE_GENERATION_TIMEOUT_MS, fileCfg.dashscopeProvider?.generationTimeoutMs, 180_000),
        baseUrl: pickStr(env.DASHSCOPE_BASE_URL, fileCfg.dashscopeProvider?.baseUrl, "https://dashscope.aliyuncs.com"),
        customModels: pickStr(env.DASHSCOPE_CUSTOM_MODELS, fileCfg.dashscopeProvider?.customModels, ""),
    },
    comfy: {
