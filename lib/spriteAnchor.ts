...
export interface SpriteReferenceInput { role: "identity" | "layout" | "basis" | "base"; assetId?: string; path?: string; data?: string }
...
export function buildSpriteRowReferences(input: { recipe: SpriteRecipeRecord; anchor: ApprovedSpriteAnchor; guide: SpriteLayoutGuide; basisRowAsset?: AssetRecord }): SpriteReferenceInput[] {
